const ProfileCard = ({imageUrl, name, program, title}) => {
  return (
    <div className="m-8 p-4 flex flex-wrap justify-center text-center gap-4 bg-white dark:bg-black rounded-lg shadow-md border border-solid border-gray-300 max-w-xs min-w-40">
      <div>
